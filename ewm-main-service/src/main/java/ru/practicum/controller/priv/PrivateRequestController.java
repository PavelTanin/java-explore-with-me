...
public class PrivateRequestController {
    ...
    @PostMapping
    public ResponseEntity addRequest(@Positive @PathVariable(name = "userId") Long userId,
    ...
    public ResponseEntity deleteRequest(@Positive @PathVariable(name = "userId") Long userId,
    ...
    @GetMapping
    public ResponseEntity getAllUserRequest(@Positive @PathVariable(name = "userId") Long userId) {
